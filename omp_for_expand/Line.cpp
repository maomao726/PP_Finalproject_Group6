...
bool Line::isVertical() const
{
  ...
  return (fabs(atan2(n.y, n.x)) < 80 * CV_PI / 180) || (fabs(atan2(-n.y, -n.x)) < 80 * CV_PI / 180);
}
...
bool Line::isHorizontal() const {
    ...
    return (fabs(atan2(n.y, n.x)) < 15 * CV_PI / 180) || (fabs(atan2(-n.y, -n.x)) < 15 * CV_PI / 180);
}